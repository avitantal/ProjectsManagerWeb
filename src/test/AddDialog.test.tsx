...
describe('AddDialog — task', () => {
  ...
  it('shows "עריכת משימה" heading when editing', () => {
    const task = { id: 1, project_id: null, name: 'משימה', status: 'todo' as const, priority: 'normal' as const, due_date: null, notes: null, is_suggested: false, created_at: '', updated_at: '', closed_at: null };
